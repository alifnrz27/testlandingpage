    ...
    <a class="screen-reader-text skip-link" title="Skip to content">Skip to content</a>
        ...
        <div class="inside-header grid-container flex justify-between" style="padding-top:20px">
            ...
            <div>
                ...
                @auth
                <a style="background-color: rgb(156 163 175 / var(--tw-bg-opacity));" class="gb-button gb-button-169c0c68 bg-gray-400" href="{{ $url }}/login"><span class="gb-button-text">Dashoard</span></a>
                @else
